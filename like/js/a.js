...
function(W, D, E) {
    function fc() {
        var a, b, c, d, e;
        if ((c = (c = W.navigator) ? c.plugins: null) && c.length) for (d = 0; d < c.length && !b; d++) e = c[d],
        ...
        return b && (a = b.match(/[\d]+/g)) && 3 <= a.length && (b = a[0] + "." + a[1] + " r" + a[2]),
        b || void 0
    }
    function Ic(a, b) {
        for (var c = new Date,
    ...
    try {
        ...
        pf = navigator, u = function(a, b, c) {
            var d = W[a];
            return W[a] = void 0 === d || c ? b: d,
            W[a]
        },
        K = function(a, b, c, d) {
        ...
        max_sp = 0, seFlag = !1, sp = function() {
            var d, a = W.pageYOffset || D.documentElement.scrollTop || D.body.scrollTop,
            b = D.documentElement.scrollHeight || D.body.scrollHeight,
            c = D.documentElement.clientHeight || D.body.clientHeight;
            return b > c ? (d = parseInt(100 * (a / (b - c))), d > max_sp && (max_sp = d), d) : (max_sp = 100, seFlag = !0, max_sp)
        },
        spF = function() {
            var scrollPercent = sp();
            max_sp >= 100 && RR(W, "scroll", spF),
            !seFlag && scrollPercent > 80 && (eval(py_n + "('event','scrollEvent')"), seFlag = !0)
        },
        ...
        xf = function(a, b) {
            ...
            return e && !c[String(e.tagName).toLowerCase()] && (e = null),
            e
        },
        yf = !1, zf = [], Af = function() {
            if (!yf) {
        ...
        S = function(a, b, c, d, e) {
            return a = new bb(a, b, c, d, e),
            Qa.set(a.name, a),
            a.name
        },
        SE = function(a, b, c, d, e, f) {
            return a = new bb(a, b, d, e, f),
            a.p = c,
            Qa.set(a.name, a),
            a.name
        },
        ...
        za = function(a, b) {
            ...
            for (c = {},
            d = Math.min(a.length + 1, b.length), e = 0; d > e; e++) {
        ...
        ee.prototype.setParam = function(a, b, c, d) {
            this.keys.push(a),
            d ? this.m[":" + a] ? this.m[":" + a][c] = b[c] : this.m[":" + a] = b: this.values[":" + a] ? this.values[":" + a][c] = b[c] : this.values[":" + a] = b
        },
        ...
        ee.prototype.map = function(a) {
            var b, c, d;
            for (b = 0; b < this.keys.length; b++) c = this.keys[b],
            d = this.get(c),
            d && a(c, d)
        },
        Ya = function() {
        ...
        Qa = new ee, Za = [], Ya.prototype.get = function(a) {
            var b = $a(a),
            c = this.data.get(a);
            return b && void 0 == c && (c = ea(b.defaultValue) ? b.defaultValue() : b.defaultValue),
        ...
        py_n = qa(W._CommandName_) && raa(W._CommandName_) || "py", clonePy = function(a, b, c) {
            var d = function() {
                var c = arguments;
                return c.length && a[b].$.e(c),
                a[b].track = function(d) { (c.t = []).push(arguments),
                    d && a[b].$.t(c)
                },
                a[b]
            };
        ...
        function(a) {
            ...
            cmFun: function(a) {
                ...
                try {
                    ...
                    g = ra("javascript:'<script>" + e + "</script>'", this.timeOutCm),
                    g.name = "_pycmifr"
                } catch(h) {}
            },
            timeOutCm: function() {
        ...
        W.ipy = {
            ...
            cookie: {
                set: function(a, b, c, d, e) {
                    z = new Date,
                    z.setTime(z.getTime() + (c || 0)),
                    D.cookie = a + "=" + E(b || "") + (c ? "; expires=" + z.toGMTString() : "") + ";path=/; domain=" + (d || ("localhost" == location.hostname ? "": location.hostname)) + (e ? "; secure": "")
                },
                get: function(a) {
            ...
            setCookie: function(a, b) {
                this.cookie.set(a, b, 31536e6, getHostName())
            },
            setSession: function(a, b) {
                this.cookie.set(a, b, 0, getHostName())
            },
            getJump: function() {
            ...
            getQueryString: function(a) {
                var b = new RegExp("(^|&)" + a + "=([^&]*)(&|$)"),
                c = W.location.search.substr(1).match(b);
                return null != c ? c[2] : ""
            },
            getP: function() {
                var a = pa.get("viewItem"),
                b = ipy.id ? ipy.id: "";
                return a = a ? a: b
            },
            getSession: function() {
            ...
            css: {
                hasClass: function(a, b) {
                    var e, c = !1,
                    d = this.getArrayOfClassNames(a);
                    for (e = 0; e < d.length; e++) b == d[e] && (c = !0);
                    return c
                },
                getArrayOfClassNames: function(a) {
                    var b = [];
                    return a.className && (b = a.className.split(" ")),
                    b
                }
            },
            getElementsByClassName: function(a, b, c) {
                ...
                for (d = null, d = c ? c.getElementsByTagName("*") : b.getElementsByTagName("*"), e = [], f = 0; f < d.length; f++) g = d[f],
                ipy.css.hasClass(g, a) && e.push(g);
                return e
            },
            guid: function() {
        ...
        pv = function() {
            ...
            c = function() {
                ...
                return "number" == typeof window.screenX && ["webkit", "moz", "ms", "o", ""].forEach(function(d) {
                    0 == c && void 0 != document[b(d, "hidden")] && (a = d, c = !0)
                }),
                c
            } (),
            d = function() {
                return c ? document[b(a, "hidden")] : !1
            },
            e = function() {
                return c ? document[b(a, "visibilityState")] : void 0
            };
            return {
                hidden: d(),
                state: e(),
                ...
                change: function(b, f) {
                    return f = !1,
                    c && "function" == typeof b ? py.$.addEvent(D, a + "visibilitychange",
                    function(a) {
                        this.hidden = d(),
                ...
                sumTime: function() {
                    var a = new Date;
                    return this.total = this.total + (a - this.visibilityTime),
                    this.visibilityTime = a,
                    this.total
                }
            }
        } (), sEle = function(a) {
            var e, f, g, h, b = "[a-zA-Z]*\\[\\s*name\\s*=.*\\]",
            c = new RegExp(b),
            d = c.exec(a);
            for (null != d && (e = d[0].replace(/\s+/g, ""), a = a.replace(d[0], e)), a = a.replace(/\s+/g, " "), f = a.split(" "), g = [], h = 0; h < f.length; h++) g = 0 == h ? D: g,
            g = find(f[h], g);
            return g
        },
        ...
        getNameChild = function(a, b, c) {
            var d, f, g, e = [];
            for (f = 0; f < a.childNodes.length; f++) if (ch = a.childNodes[f], "#text" != ch.nodeName) if (ch.localName == c && ch.getAttribute("name") == b) e.push(ch);
            else for (d = getNameChild(ch, b), g = 0; g < d.length; g++) e.push(d[g]);
            return e
        },
        cb = "cb", py[cb] = function(a, b) {
            ...
            try {
                ...
                cmf.cmFun(a),
                b && 0 == b.code && null != b.data && cvdFun(b.data),
                d = pa.get("clickParam") && pa.get("clickParam").cpk || "pyck",
                e = ipy.getQueryString(d),
                e = e ? e: ipy.getInfo("ipycookie"),
                ipy.setInfo("ipycookie", e),
                exeFun()
            } catch(f) {}
        },
        cvdFun = function(d) {
        ...
        setEvent = function(a) {
            ...
            for (pa.get(b) && pa.set(b, null), cvt.get(b) && cvt.set(b, null), c = 2; c < a.length; c++) c == a.length - 1 ? "leads" == b || "custom" == b || "register" == b ? fa(a[c]) ? (a[c].id ? pa.setParam(b, {
                id: a[c].id
            },
            "id") : "", a[c].data ? pa.setParam(b, {
                dt: a[c].data
            },
            "dt") : "", a[c].customEvent ? pa.setParam(b, {
                ce: a[c].customEvent
            },
            "ce") : "") : setParam(a, c) : fa(a[c]) ? (a[c].trackId && (a.t = a[c].trackId, delete a[c].trackId), pa.set(b, Fa(a[c], pa.get(b)))) : setParam(a, c) : setParam(a, c);
            if ("order" == b || "viewCart" == b || "purchase" == b) {
                for (d = pa.get(b), d.mn && (pa.set(b, {
                    mn: d.mn
                }), cvt.setParam(b, {
                    Money: d.mn
                },
                "Money")), d.id && (pa.setParam(b, {
                    od: d.id
                },
                "od"), cvt.setParam(b, {
                    OrderNo: d.id
                },
                "OrderNo")), _pl = "", e = 0; e < d.it.length; e++) f = d.it[e],
                _pl += (f.id ? f.id: "") + "," + (f.ct ? f.ct: "") + "," + (f.pr ? f.pr: "") + ";";
                "" != _pl && (pa.setParam(b, {
                    pl: _pl
                },
                "pl"), cvt.setParam(b, {
        ...
        b_serialize = function(a, b, c) {
            ...
            return e += f.join("&"),
            e += pa.get("user") && Ha(pa.get("user")) ? "&ur=" + E(Ha(pa.get("user"))) : "",
            e += pa.get("site") && Ha(pa.get("site")) ? "&st=" + E(Ha(pa.get("site"))) : "",
            e += pv.support ? "&vb=1&vbt=" + (pv.hidden ? pv.total: pv.sumTime()) : "&vb=0",
            e += "&sp=" + max_sp,
            (void 0 != b || "" != b) && (i = pa.get(b), e += b ? "&ev=" + Qa.get(b).F: "", e += 1 == a && "custom" == b ? i && i.ce ? "&ce=" + i.ce: "": "", e += b ? 0 == a ? "" == c ? i && Ha(i) ? "&ep=" + E(Ha(i)) : "": "": cvt.get(b) && cvt.get(b).ProductList ? "": i && "viewItem" != b && "custom" != b ? "&ep=" + E(Ha(i)) : "": ""),
            e
        },
        cvtE = function(a) {
            var d, b = cvt.get(a),
        ...
        getPi_p = function(a) {
            ...
            if ("viewItem" == a) {
                if (c = pa.get(a), void 0 != c) {
                    b = pa.get(a).pn ? "&p=" + pa.get(a).pn: "",
                    f = c.pis && c.pis.replace("x", "X").split("X"),
                    g = c.ms && c.ms.replace("x", "X").split("X"),
                    delete pa.get(a).pis,
                    delete pa.get(a).ms,
                    f && 2 == f.length && (pa.setParam(a, {
                        pw: f[0]
                    },
                    "pw"), pa.setParam(a, {
                        ph: f[1]
        ...
        removeFun = function(a) {
            var d, e, f, c = [];
            if (kaa(a)) for (d = a.length - 1; d >= 0; d--) if (e = a[d], "remove" == e[0]) c.push(e),
            a.splice(d, 1);
            else for (f = 0; f < c.length; f++) if (e[0] == c[f][1] && e[1] == c[f][2]) {
                a.splice(d, 1);
                break
            }
        },
        ...
        exeFun = function() {
            ...
            for (b = 0; b < a.length;)"mapping" != a[b][1] && execute(a[b]),
            a.splice(b, 1)
        },
        dcpy = function(a) {
            ...
            for (c in a) d = a[c],
            e = Ca(d),
            b[c] = "array" == e || "object" == e ? dcpya(d) : a[c];
            return b
        },
        dcpya = function(a) {
            var c, b = {};
        ...
        if (cu = cu || "pyck", d = ipy.getQueryString(cu), d = d ? d: ipy.getInfo("ipycookie"), ipy.setInfo("ipycookie", d), p(("https:" == location.protocol ? "https": "http") + "://stats.ipinyou.com/presadv?a=" + E(py.a) + "&cb=" + py_n + "." + cb,
        function() {},
        function() {
            try {
                exeFun()
            } catch(b) {}
        }), seFlag || U(W, "scroll", spF), "interactive" == D.readyState && !D.createEventObject || "complete" == D.readyState) rf();
        else {
