(function(j, K, g) {
    ...
    if (k) {
        ...
        H = _py.getLast("urlParam"); (function(i, q, p, f, e) {
            i._CommandName_ = f;
            i[f] = i[f] ||
            function() { (i[f].q = i[f].q || []).push(arguments);
        ...
        _py.serialize = function() {
            ...
            for (var f = ["domain", "urlParam", "pi", "e", "p", "mapping"], a = [], e = [], q = [], d, c = 0; c < this.length; c++) {
                d = this[c][0],
                -1 === p(f, d) && (e[d] = e[d] || [], 0 < e[d].length ? -1 === p(e[d], this[c][1]) && e[d].push(this[c][1]) : (e[d].push(this[c][1]), a.push([d, e[d]])))
            }
        ...
        j.ipy = {
            ...
            extendSend: function(a) {
                ...
                c += a,
                o = _py.getLast("domain"),
                x = ("https:" == location.protocol ? "https": "http") + "://" + o + "/adv?" + _py.serialize() + ipy.getSession() + "&e=" + h(c) + "&rd=" + new Date().getTime(); (new Image()).src = x
            },
            getSession: function() {
                var d = _py.getLast("c");
                if (d && d != null) {
